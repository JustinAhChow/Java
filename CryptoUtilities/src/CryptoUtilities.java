...
public final class CryptoUtilities {
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber wSq = new NaturalNumber2(w);
        wSq.power(2);
        wSq.divide(n);
        ...
        if (wSq.equals(one) || !w2.equals(one)) {
            result = true;
        }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        NaturalNumber two = new NaturalNumber2(2);
        NaturalNumber one = new NaturalNumber2(1);
        NaturalNumber comparative = new NaturalNumber2();
        ...
        int i = 0;
        while (i < 50 && result == false) {
            if (n2.compareTo(two) >= 0) {
                comparative = new NaturalNumber2(randomNumber(n2));
            } else {
                comparative = new NaturalNumber2(n2);
            }
            if (n.compareTo(two) > 0 && comparative.compareTo(one) > 0) {
                result = isWitnessToCompositeness(comparative, n);
            }
            i++;
        }
